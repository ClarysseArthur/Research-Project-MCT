...
def render_3d(approaches, exits):
    ...
    for i, x in enumerate(lanes_length):
        ...
        if x == 1:
            ...
            hl.AddPhysicBox(xyz3[0][0], xyz3[0][1], xyz3[0][2], size_x=xyz_dim[0], size_y=xyz_dim[1], size_z=xyz_dim[2], color=hl.Color.Red)
            hl.AddPhysicBox(xyz3[1][0], xyz3[1][1], xyz3[1][2], size_x=xyz_dim[0], size_y=xyz_dim[1], size_z=xyz_dim[2], color=hl.Color.Blue)
            hl.AddPhysicBox(xyz3[2][0], xyz3[2][1], xyz3[2][2], size_x=xyz_dim[0], size_y=xyz_dim[1], size_z=xyz_dim[2], color=hl.Color.Green)
